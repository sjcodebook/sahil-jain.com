...
export default function Container(props) {
  ...
  const router = useRouter();
  const meta = {
    title: 'Sahil Jain – Full Stack Web3 Developer',
    description: `Full Stack Web3 developer, Web3 enthusiast, and Content Creator.`,
    image: 'https://sahiljain.io/static/avatar.jpg',
    type: 'website',
    ...customMeta
  };
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      <Head>
        ...
        <meta name="twitter:site" content="@0xsahiljain" />
